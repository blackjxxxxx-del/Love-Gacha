...
const DECORATIONS = [
  { src: "/Im/sacdsacfasc.png",            x: -82, y: 20,  size: 38, delay: 0,    dur: 2.8 },
  { src: "/Im/scascfsaf.png",              x: -68, y: 90,  size: 32, delay: 0.5,  dur: 3.1 },
  { src: "/Im/sacdvewvre.png",             x: -78, y: 155, size: 30, delay: 1.1,  dur: 2.6 },
  { src: "/Im/teddy-bear_4841256.png",     x: -58, y: 52,  size: 34, delay: 0.3,  dur: 3.4 },
  { src: "/Im/wefwefewf.png",              x:  72, y: 20,  size: 36, delay: 0.7,  dur: 2.9 },
  { src: "/Im/acadc7.png",                 x:  62, y: 90,  size: 30, delay: 0.2,  dur: 3.2 },
  { src: "/Im/give-love_5680123.png",      x:  74, y: 155, size: 32, delay: 0.9,  dur: 2.7 },
  { src: "/Im/love_2839131.png",           x:  56, y: 52,  size: 34, delay: 1.3,  dur: 3.0 },
  { src: "/Im/teru-teru-bozu_7096623.png", x: -38, y: -20, size: 28, delay: 0.6,  dur: 3.5 },
  { src: "/Im/pigeon_818600.png",          x:  34, y: -18, size: 28, delay: 0.4,  dur: 3.3 },
];
